function realizeNTF(ntf,form,stf)
    ...
    ntf_z_roots = roots([1.00000000000000 + 0.00000000000000im, 0.999188974764100 + 0.0402665209555813im, 0.999188974764100 - 0.0402665209555813im, 0.997703673259689 + 0.0677302027468142im, 0.997703673259689 - 0.0677302027468142im])
    ...
    if form =='CRFB'
            ...
            for i=1:order*2
                ...
                z = zSet[i] 
                 #L1(z) = 1-1/H(z)
                L1[i] = 1-ntf_z_roots/ntf_z_roots
                Dfactor = (z-1)/z
                product=1
                for j=order:-2:(1+odd)
